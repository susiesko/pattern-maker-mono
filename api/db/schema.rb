...
ActiveRecord::Schema[8.0].define(version: 20_250_309_170_034) do
  ...
  create_table 'bead_color_links', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[bead_id color_id], name: 'index_bead_color_links_on_bead_id_and_color_id', unique: true
  ...
  create_table 'bead_finish_links', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[bead_id finish_id], name: 'index_bead_finish_links_on_bead_id_and_finish_id', unique: true
